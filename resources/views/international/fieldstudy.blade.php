	...
	<body class="container">
		...
		<div class="d-flex p-md-5 justify-content-md-center align-items-md-center vh-100 homepage-container px-2 py-4">
				...
				<div class="d-flex justify-content-between box-item">
					<div class="d-flex flex-column">
						<div class="left-content">
							<p class="text-uppercase">step 5 of 9</p>
						...
						<span class="d-flex align-items-md-center cursor-pointer gap-2" role="button" id="backToCampus">
					...
					<div class="campus-grid card-box">
						<a href="/international/programmajor">
			...
			<div class="d-flex flex-column d-md-none">
				<div class="upper-content d-flex align-items-center gap-3">
					...
					<span class="text-white" onclick="window.location.href = '/international/campus'">
						<p class="mobile-title">Step 5 of 9</p>
		...
		<script>
			document.getElementById("backToCampus").addEventListener("click", function(event) {
				...
				window.location.href = "/international/campus";
			});
		</script>
	</body>
