		...
		<div class="d-flex p-md-5 justify-content-md-center align-items-md-center vh-100 homepage-container px-2 py-4">
			...
			<div class="card card-container d-none d-md-block p-5">
				<div class="d-flex justify-content-between box-item">
					...
					<div class="card-box-review w-75">
						...
						<div>
							<button type="button" class="btn link back-review-btn" data-bs-dismiss="modal" onclick="window.location.href = '/international/personalinformation'">
			...
			<div class="d-flex flex-column d-md-none">
				<div class="upper-content d-flex align-items-center gap-3">
					...
					<span class="text-white" onclick="window.location.href = '/international/personalinformation'">
						<p class="mobile-title">Step 9 of 9</p>
