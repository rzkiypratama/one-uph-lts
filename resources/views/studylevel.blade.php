					...
					<div class="d-flex flex-column card-box fade-in-right gap-3">
						<a href="/campus">
							<div class="card-nationality border-0"
								style="background-image: url('/assets/studylevel1.png'); height: 133px; width: 558px; background-position: top">
								<!-- Gradient Overlay -->
						...
						<a href="/campus">
							<div class="card-nationality border-0"
								style="background-image: url('/assets/studylevel2.png'); height: 133px; width: 558px; background-position: top">
								<!-- Gradient Overlay -->
								<div class="gradient-overlay" style="background-image: linear-gradient(to top, #bcd1ff, #f1f1f122)" \>
								</div>
			...
			<div class="d-flex flex-column d-md-none">
				<div class="upper-content d-flex align-items-center gap-3">
					...
					<span class="text-white" onclick="window.location.href = '/nationality'">
						<p class="mobile-title">Step 2 of 8</p>
				...
				<div class="card rounded-4 middle-content p-3">
					...
					<div class="bagian-bawah d-flex flex-column justify-content-between h-100">
						<div class="d-flex flex-column card-box fade-in-bottom gap-3">
							<a href="/campus">
								<div class="card-nationality border-0"
									style="background-image: url('/assets/studylevel1.png'); height: 180px; width: auto; background-position: top">
									<!-- Gradient Overlay -->
									<div class="gradient-overlay" style="background-image: linear-gradient(to top, #bcd1ff, #f1f1f122)" \>
									</div>
							...
							<a href="/campus">
								<div class="card-nationality border-0"
									style="background-image: url('/assets/studylevel2.png'); height: 180px; width: auto; background-position: top">
									<!-- Gradient Overlay -->
									<div class="gradient-overlay" style="background-image: linear-gradient(to top, #bcd1ff, #f1f1f122)" \>
									</div>
