        ...
        <div class="card card-container p-5">
            <div class="d-flex justify-content-between box-item">
                ...
                <div class="card-box-review w-75">
                    ...
                    <div class="card-body">
                        <!-- please add hidden input and get the values from localstorage -->
                        <div class="row">
                    ...
                    <div class="float-end">
                        <button type="button" class="btn select-program-btn rounded-0 px-5" data-bs-toggle="modal" data-bs-target="#successModal">Verify  
                    ...
                    <div>
                        <button type="button" class="btn link back-review-btn" data-bs-dismiss="modal"><a href="/personalinformation"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                          ...
                          </svg> Edit your Personal Data</button>
                    </div> </a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center">
                <div class="modal-body modal-body-review">
                    <img src="/assets/success.png" class="img-fluid mb-3" alt="Success Image"> <!-- Replace with your image path -->
                    <p class="fs-4 mb-2 review-modal-title">Registration Success</p>
                    <p class="mb-4 review-modal-subtitle d-flex flex-column align-items-center">Your account has been created. <span>Please continue to fill Application Form.</span></p>
                    <a href="/login">
