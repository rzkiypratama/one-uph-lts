...
<html lang="en">
	...
	<body class="container mt-3">
				...
				<div class="card-body">
					...
					<form id="myForm" class="d-flex flex-column justify-content-between h-100">
						...
						<div class="d-flex justify-content-between align-content-center mb-4">
							<button type="button" class="btn btn-outline-danger float-end rounded-0 mt-5 px-5" onclick="window.location.href = '/dashboard/educationbackground'">
							...
							<!-- Submit Button -->
							<button type="button" class="btn btn-danger float-end rounded-0 danger-button mt-5 px-5" data-bs-toggle="modal" data-bs-target="#admissionModal">
								Save Data & Continue
		...
		<script src="/js/entryoption.js"></script>
	</body>
