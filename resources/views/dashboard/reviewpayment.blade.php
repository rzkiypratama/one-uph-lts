				...
				<div class="card-body">
					...
					<form id="myForm" class="d-flex flex-column justify-content-between h-100">
						...
						<div class="d-flex justify-content-between align-content-center mb-4">
							...
							<button id="proceedToPaymentBtn" type="submit" class="btn btn-danger float-end rounded-0 danger-button mt-5 px-5" data-bs-toggle="modal" data-bs-target="#firstPaymentModal">
								Proceed to Payment
							...
							<button id="verifyApplicationBtn" type="submit" class="btn btn-danger float-end rounded-0 danger-button mt-5 px-5" onclick="window.location.href='/dashboard/applicationstatus'">
