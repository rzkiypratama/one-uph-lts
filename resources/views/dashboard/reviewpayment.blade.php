				...
				<div class="card-body">
					...
					<form id="myForm" class="d-flex flex-column justify-content-between h-100">
						...
						<div class="d-flex justify-content-between align-content-center mb-4 gap-3">
							<button type="button" class="btn btn-outline-danger d-flex align-items-center float-end rounded-0 px-md-5 mt-5 px-4" onclick="window.location.href = '/dashboard/entryoption';">
							...
							<button id="proceedToPaymentBtn" type="submit" class="btn btn-danger float-end rounded-0 px-md-5 danger-button mt-5" data-bs-toggle="modal" data-bs-target="#firstPaymentModal">
								Proceed to Payment
