				...
				<div class="card-body">
					...
					<form id="myForm" class="d-flex flex-column justify-content-between h-100">
						...
						<div class="d-flex justify-content-between align-content-center mb-4 gap-3">
							<button type="button" id="backButton" class="btn btn-outline-danger rounded-0 px-md-5 float-end">
							...
							<!-- Submit Button -->
							<button type="submit" id="submitBtn" class="btn btn-danger rounded-0 danger-button float-end px-5">
								save & continue
