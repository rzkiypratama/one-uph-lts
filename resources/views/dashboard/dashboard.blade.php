			...
			<div class="d-flex justify-content-between align-items-center">
				<div class="w-100 pe-4">
					...
					<span class="d-flex justify-content-between align-items-end">
						...
						<button type="button" class="btn btn-outline-primary dashboard-edit px-4"><svg
				...
				<div class="dashboard-box">
					<div class="card-dashboard border-0"
						...
						<div class="title-container w-100">
							...
							<button type="button" class="text-capitalize btn btn-danger w-100 dashboard-button mt-4 border-0"
				...
				<div class="modal-content">
					<div class="modal-body d-flex justify-content-between p-5">
						...
						<div class="w-50 mb-3 pe-3 text-center">
							...
							<input type="text" class="form-control e-code-input my-3 text-center" id="ecodeInput"
								placeholder="--- --- ---" maxlength="15">
							<button type="button" id="submitEcodeBtn" class="btn btn-primary w-100 rounded-0 mt-3"
						...
						<div class="w-50 d-flex flex-column justify-content-between mb-3 ps-3 text-center">
							...
							<a href="/dashboard/intakeyear">
								<button type="button" class="btn btn-primary w-100 rounded-0 float-end mt-3">Proceed without
									E-code</button>
							</a>
						</div>
					</div>
			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-payment">
				<div class="modal-content border-0">
					...
					<div class="modal-body">
						...
						<div class="payment-background">
							<div class="d-flex flex-column gap-1 p-4">
								<!-- Bank BCA -->
								<label
									class="bank-option d-flex justify-content-between align-items-center rounded-3 border p-3"
									for="bankBca">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger rounded-0 w-100 danger-button border-0 px-5"
						...
						<div class="payment-background">
							<div class="d-flex flex-column gap-1 p-4">
								<div class="pe-3">
									...
									<hr class="solid-fullwidth">
									<button type="button"
										class="btn btn-primary rounded-0 payment-title mb-3 border-0 text-white">How
										to Pay</button>
								</div>
							</div>
						</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						...
						<button type="button" id="nextStepPayment"
							class="btn btn-danger rounded-0 w-100 danger-button border-0 px-5" onclick="window.location.href='/dashboard/intakeyear'">Next
							Step</button>
					</div>
				</div>
			</div>
