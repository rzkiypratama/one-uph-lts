...
<body class="container mt-3">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="w-100 pe-4">
                ...
                <span class="d-flex justify-content-between align-items-end">
                    ...
                    <button type="button" class="btn btn-outline-primary px-4 dashboard-edit"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="14" fill="currentColor"
                ...
                <p class="text-capitalize m-0 dashboard-bottom-title ">application status</p>
                <div class="d-grid gap-2 mt-2">
                    <p class="badge fw-medium m-0">Your current application status is <span
                            class="fw-semibold">Registered</span></p>
                    <p class="badge fw-medium m-0">Your next step is <span class="fw-semibold">Buy a Registration
                            Form</span></p>
                </div>
            </div>
            ...
            <div class="dashboard-box">
                <div class="card-dashboard border-0"
                    style="background-image: url('/assets/student.jpeg'); height: 461px; width: 272px;">
                    <!-- Gradient Overlay -->
                    ...
                    <div class="title-container w-100">
                        ...
                        <button type="button" class="text-capitalize btn btn-danger w-100 border-0 dashboard-button"
                            data-bs-toggle="modal" data-bs-target="#ecodeModal">buy new form</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body d-flex justify-content-between p-5">
                    <!-- Left Side Content -->
                    <div class="w-50 pe-3 text-center mb-3">
                        <h5 class="review-modal-title">I have an E-code</h5>
                        <p class="m-0 review-modal-subtitle">Please enter your E-code</p>
                        <input type="text" class="form-control e-code-input text-center my-3" id="ecodeInput"
                            placeholder="--- --- ---" maxlength="15">
                        <button type="button" id="submitEcodeBtn" class="btn btn-primary mt-3 w-100 rounded-0"
                            disabled>Submit E-code</button>
                    ...
                    <!-- Right Side Content -->
                    <div class="w-50 ps-3 text-center d-flex flex-column justify-content-between mb-3">
                        <div>
    ...
    <div class="modal fade" id="eCodeValidModal" tabindex="-1" aria-labelledby="eCodeValidModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <button type="button" class="btn btn-danger danger-button border-0 rounded-0 px-5 py-2" data-bs-toggle="modal" data-bs-target="#firstPaymentModal">Proceed to Payment</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-payment">
            <div class="modal-content border-0">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger px-5 rounded-0 w-100 border-0 danger-button"
                        data-bs-target="#confirmationModal" data-bs-toggle="modal">Proceed to
                        Payment</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-verify">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger px-5 rounded-0 w-100 border-0 danger-button"
                        data-bs-target="#successModal" data-bs-toggle="modal" id="submitFirstModal">Verify
                        Payment</button>
                </div>
            </div>
        </div>
