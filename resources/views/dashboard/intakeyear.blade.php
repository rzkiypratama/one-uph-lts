                        ...
                        <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#tab1"
                            ...
                            <div class="d-flex">
                                ...
                                <span class="d-flex flex-column text-start">
                                    <p class="m-0 tabs-title text-capitalize">Intake Year</p>
                                    <p class="m-0 tabs-subtitle">intake year information</p>
                                </span>
                            </div>
                        </button>
                    </li>
            ...
            <div class="card-body">
                ...
                <form id="myForm" class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex justify-content-between align-content-center mb-4">
                        <button type="button" class="btn btn-outline-danger mt-5 float-end rounded-0 px-5"
                            onclick="window.location.href = '/dashboard'"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="btn btn-danger mt-5 float-end rounded-0 px-5 danger-button">Save
